...
SELECT
    ...
    cl.Nombres,
    (SELECT
    count(pe.FechaSolicitud) cant
    from Pedidos pe
    where year(pe.FechaSolicitud)= 2020) Año2020
from Clientes cl
    ...
    (SELECT
        pe.FechaSolicitud
        from Pedidos pe
        where year(pe.FechaSolicitud)= 2021) Año2021,
    (SELECT
        pe.FechaSolicitud
        from Pedidos pe
        where year(pe.FechaSolicitud)= 2022) Año2022
